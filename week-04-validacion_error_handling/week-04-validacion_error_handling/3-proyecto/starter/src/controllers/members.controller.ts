...
export async function getById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const member = await service.findById(parsed.data);
    res.json({ data: member } satisfies SingleResponse<typeof member>);
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const dto: CreateMemberDto = result.data;
    const member = await service.create(dto);
    res.status(201).json({ data: member } satisfies SingleResponse<typeof member>);
  } catch (err) {
    next(err);
  }
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const dto: UpdateMemberDto = result.data;
    const member = await service.update(parsedId.data, dto);
    res.json({ data: member } satisfies SingleResponse<typeof member>);
  } catch (err) {
    next(err);
  }
